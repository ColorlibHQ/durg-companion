...
----------------------------------------*/
class durg_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('durg_instagram_photo',esc_html__('[ Durg ] Intagram Photo','durg'),array(
			'description' => esc_html__('Durg Instagram Photo Widget','durg'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'durg');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'durg'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'durg'); ?></label>
...
if(!function_exists('durg_instagram_widgets')):
	function durg_instagram_widgets(){
		register_widget('durg_instagram_photo');
	}
	add_action('widgets_init','durg_instagram_widgets');
endif;
