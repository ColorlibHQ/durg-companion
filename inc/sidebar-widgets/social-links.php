...
class Durg_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Durg ] Social Links', 'durg' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'durg' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'durg' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'durg'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'durg'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'durg'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'durg'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'durg'); ?></label>
...
} // Class durg_social_links ends here


// Register and load the widget
function durg_social_links_widget_load() {
	register_widget( 'Durg_social_links' );
}
add_action( 'widgets_init', 'durg_social_links_widget_load' );